...
For ADR references: `// REF: docs/adr/0007-per-milestone-prd.md`.

Forms catalogued in [references/shared/citation-prefixes.md](./references/shared/citation-prefixes.md).
